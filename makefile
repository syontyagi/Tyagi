...
b.out: sachimain.o input.o gameover.o displaymatrix.o
	gcc -o b.out sachimain.o input.o gameover.o displaymatrix.o

sachimain.o: sachimain.c input.h gameover.h displaymatrix.h
